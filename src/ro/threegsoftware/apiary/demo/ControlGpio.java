...
public class ControlGpio {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final GpioPinDigital pin7 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_07, "RHT03", PinState.HIGH);
        ...
        //final GpioPinAnalogInput analogInPin = gpio.provisionAnalogInputPin(RaspiPin., null)
        Thread.sleep(5000);
